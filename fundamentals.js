...
var foods = ['potato', 'broccoli', 'apple'];
...
// var last = foods.lastIndexOf();
var last = foods[lastIndexOf([0])]
console.log(last);
...
var favoriteFoods = ['chicken', 'lamb', 'bruschetta'];

// #4: Create a `for` loop that adds each string in `foods` to `favoriteFoods`.
// Type your solution immediately below this line:

for(i = 0; i < favoriteFoods.length; i++){
    favoriteFoods.concat(foods);
}
