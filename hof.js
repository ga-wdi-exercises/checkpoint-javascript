...
// called `peopleNames`.
// Type your solution immediately below this function getFields(people, field) {
var peopleNames = people.map(names, i, people ) => {
    return people.name
  }
...
var polyglotPeople = people.filter(kL => kL.knownLanguages.excludes(1))
