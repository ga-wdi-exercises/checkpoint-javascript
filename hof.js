...
var peopleNames = people.map(function getName(name) {
  return name.name
})
...
var polyglotPeople = people.filter(function languageCheck(knownLanguages) {
  return knownLanguages.knownLanguages > 1
});
