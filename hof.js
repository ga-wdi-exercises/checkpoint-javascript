...
var peopleNames = people.map(function(ph){
 var newString = ph.name
 return newString
})
...
var polyglotPeople = people.filter(function(ph){
  // var newArray = 
  if(ph.knownLanguages > 1){
    var newArray = ph.knownLanguages
    return newArray
  }
})
